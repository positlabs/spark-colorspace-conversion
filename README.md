## Colorspace conversion for non-shader colors in Spark AR

The built-in colorspace patch in Spark is meant for color conversions on textures. These patches will allow you to do those same color conversions for light colors and other non-texture values.
...
This was translated into Spark from [this article](http://lolengine.net/blog/2013/07/27/rgb-to-hsv-in-glsl) on lolengine.net
